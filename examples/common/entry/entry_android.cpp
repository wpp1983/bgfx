...
namespace entry
{
    ...
    public:
        ...
        void SetAssetManager(AAssetManager* In)
        {
            m_assetManager = In;
        }
    ...
    struct Context
    {
        ...
        {
            m_app = _app;
            assetManager = _app->activity->assetManager;
...
//			);
        ...
        FileReaderAndroid* reader = BX_NEW(getAllocator(), FileReaderAndroid);
        reader->SetAssetManager(s_ctx.assetManager);
        entry::setFileReader(reader);
